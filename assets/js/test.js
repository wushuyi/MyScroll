...
/***/ function(module, exports, __webpack_require__) {
	...
	var EasyScroller = _interopRequire(__webpack_require__(1));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MyScroll = _interopRequire(__webpack_require__(2));

	var vendorPrefixJsStyle = __webpack_require__(3).vendorPrefixJsStyle;

	var MyEasyScroll = (function () {
	    function MyEasyScroll(content, options) {
	        _classCallCheck(this, MyEasyScroll);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var effect = _interopRequire(__webpack_require__(4));

	var noop = _interopRequire(__webpack_require__(5));

	var _utilTween = __webpack_require__(6);

	var easeOutCubic = _utilTween.easeOutCubic;
	var easeInOutCubic = _utilTween.easeInOutCubic;

	var MyScroll = (function () {
	        function MyScroll(callback, options) {
	        ...
	        _createClass(MyScroll, {
	                ...
	                zoomTo: {
	                        ...
	                        value: function zoomTo(level, animate, originLeft, originTop, callback) {
	                                ...
	                                if (self.__isDecelerating) {
	                                        effect.stop(self.__isDecelerating);
	                ...
	                doTouchStart: {
	                        ...
	                        value: function doTouchStart(touches, timeStamp) {
	                                ...
	                                if (self.__isAnimating) {
	                                        effect.stop(self.__isAnimating);
	                ...
	                __publish: {
	                        ...
	                        value: function __publish(left, top, zoom, animate) {
	                                ...
	                                if (animate && self.options.animating) {
	                                        ...
	                                        self.__isAnimating = effect.start(step, verify, completed, self.options.animationDuration, wasAnimating ? easeOutCubic : easeInOutCubic);
	                                } else {
	                ...
	                __startDeceleration: {
	                        ...
	                        value: function __startDeceleration(timeStamp) {
	                                ...
	                                self.__isDecelerating = effect.start(step, verify, completed);
	                        }
	                },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var engine = _interopRequire(__webpack_require__(7));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var vendorPrefixJs = __webpack_require__(3).vendorPrefixJs;
	 ...
	 */
	win.requestAnimationFrame = win.requestAnimationFrame || win[vendorPrefixJs + "RequestAnimationFrame"];
	/**
	 * get standard cancelAnimationFrame
	 */
	win.cancelAnimationFrame = win.cancelAnimationFrame || win[vendorPrefixJs + "CancelAnimationFrame"] || win[vendorPrefixJs + "CancelRequestAnimationFrame"];
